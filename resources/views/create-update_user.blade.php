...
<h2 class="text-center">@if(isset($user)) Editar @else Cadastrar @endif</h2> <hr>
...
<div class="col-8 m-auto">
    ...
    @if(isset($user))
        ...
        <input type="hidden" id="product_id" value="{{$user->id}}">
    ...
    @endif
        ...
        @if (isset($user))
            <input class="form-control" type="password" name="password" id="password" placeholder="Nova senha:" value="" required><br>
